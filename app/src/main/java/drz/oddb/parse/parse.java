...
public static final int OPT_UNIONDEPUTY           = 9;
public static final int OPT_UNION_CREATE          = 10;
public static final int UNION_SELECT              = 11;
  ...
  final public int unioncreate() throws ParseException {
    trace_call("unioncreate");
    try {
        String cln;
        String attr_s;
        String value_s = "";
  ...
  private boolean jj_3R_22() {
    if (jj_scan_token(UNIONSELECT)) return true;
    if (jj_3R_25()) return true;
    return false;
  }
  ...
  private boolean jj_3R_18() {
    if (jj_scan_token(DEPUTYCLASS)) return true;
    if (jj_3R_25()) return true;
    return false;
  }
